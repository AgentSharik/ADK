...
class LoginDialog(FramelessDialog):
    ...
    def __init__(self, error_msg: str = "", saved_user: str | None = None, saved_password: str | None = None):
        super().__init__("🔑 Вход в ADK", None, (460, 560))
...
class UserCardDialog(FramelessDialog):
    ...
    def __init__(self, entry, app, parent=None):
        ...
        super().__init__(f"👤 Карточка: {fio}", parent, (940, 720))
        ...
        self.btn_toggle.setToolTip("" if disabled else "Увольнение / декрет: UAC += 2" + (" и экспорт ящика в PST" if settings.pst_backup_base else ""))
