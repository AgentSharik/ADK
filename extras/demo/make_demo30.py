"""Видео-демонстрация ADK (offscreen, заглушка LDAP) → /home/user/extras/videos/ADK_demo_30.mp4.

Ролик 28: программа работает на стендовой базе из 1500 ПК (копия extras/data/bench/pc_mapping.db + 1350 пользователей
...
Запуск: QT_QPA_PLATFORM=offscreen python /home/user/extras/demo/make_demo30.py
"""
import base64
import json
import os
...
ROOT = "/home/user"
OUT_DIR = "/home/user/extras/demo/frames30"
OUT_MP4 = "/home/user/extras/videos/ADK_demo_30.mp4"
FPS = 25
