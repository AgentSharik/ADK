...
Актуально на 2026-09-24. Версия проекта **3.9.12**, тестов **417**, e2e 46 + 83 + 45 + 41, стенд `tests/bench/` (1500 ПК), видео-ролик **32** (730 с). Раздел О — обязательный регламент работы.
