...
def contrast_text(bg_hex: str) -> str:
    """Текст (и цвет значков) на заливке акцентом: белый на насыщенных цветах, тёмный — только на очень светлых.

    3.9.1: возврат к поведению 3.8 — вариант 3.9.0 «тёмный текст на янтарном/салатовом/розовом»
    на тёмных темах выглядел как «чёрные текст и значки», пользователю не зашёл."""
