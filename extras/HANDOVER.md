...
Актуально на 2026-09-20. Версия проекта **3.9.0**, тестов **349**, e2e 46 + 83 + 45 + 41, стенд `tests/bench/` (1500 ПК), видео-ролик **31** (709 с). Раздел О — обязательный регламент работы.
...
- «Входы на ПК»: тип 11 = «Вход по кэшу», легенда под фильтрами, пустые ячейки = «—».
- Панель поиска главного окна: 2 строки (ввод+«Найти» / чекбоксы+Плагины+Настройки).
- Тесты: tests/test_scan39.py (+9), test_scan38 обновлён под 4 фазы; всего 349 (347 passed + 2 skipped).
