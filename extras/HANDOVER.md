...
- 410 passed + 2 skipped. Релиз v3.9.6: CHANGELOG-секция переписана (главный фикс первым), тег, PATCH.
...
- 410 passed + 2 skipped. Релиз v3.9.7 (тег, PATCH). В ответе юзеру — ПРЯМАЯ ссылка https://github.com/AgentSharik/ADK/releases/latest: возможно, «страница Releases» без URL была слишком абстрактной.
