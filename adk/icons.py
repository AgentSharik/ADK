...
PATHS: dict[str, str] = {
    ...
    "printer": '<path d="M7 8.5V4.5h10v4"/><rect x="2.5" y="8.5" width="19" height="9" rx="2.5"/><path d="M6.5 13.5h11v6h-11z"/><path d="M9 16.5h6"/><circle cx="18" cy="11.5" r="1.1" fill="currentColor" stroke="none"/>',
    "printer.network": '<path d="M7 8V4.5h10V8"/><rect x="2.5" y="8" width="19" height="8" rx="2.2"/><path d="M8 19.5h8M12 16v3.5"/><circle cx="18" cy="11" r="1.1" fill="currentColor" stroke="none"/>',
    "printer.usb": '<path d="M7 8V4.5h10V8"/><rect x="2.5" y="8" width="19" height="8" rx="2.2"/><path d="M12 16v4.5M9.5 19l2.5 1.5 2.5-1.5"/><circle cx="18" cy="11" r="1.1" fill="currentColor" stroke="none"/>',
    "printer.shared": '<path d="M7 8V4.5h10V8"/><rect x="2.5" y="8" width="19" height="8" rx="2.2"/><path d="M7 20h10M12 16v4"/><circle cx="7" cy="20" r="1.4" fill="currentColor" stroke="none"/><circle cx="17" cy="20" r="1.4" fill="currentColor" stroke="none"/>',
