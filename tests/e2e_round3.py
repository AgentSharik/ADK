...
check("свободный ПК с принтером: инспектор показывает ПК и бейдж Kyocera", "WS-133" in w.lbl_fio.text() and [b.text() for b in w.printers_box.findChildren(BadgeButton)] == ["Kyocera ECOSYS P3145dn · 10.0.2.51 · по умолчанию"], w.lbl_fio.text())
