...
Актуально на 2026-09-20. Версия проекта **3.9.3**, тестов **398**, e2e 46 + 83 + 45 + 41, стенд `tests/bench/` (1500 ПК), видео-ролик **32** (730 с). Раздел О — обязательный регламент работы.
