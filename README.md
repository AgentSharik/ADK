...
```bash
pyflakes adk tests
QT_QPA_PLATFORM=offscreen pytest -q          # 234 теста
```
...
- **3.5 (актуальная):** справка по роли после входа, менеджер плагинов с шаблоном, столбец «Подключение» для принтеров, 234 теста.
