...
- **3.5 (актуальная):** автоопределение параметров домена AD, справка по роли после входа, менеджер плагинов с шаблоном, столбец «Подключение» для принтеров, 255 тестов.
